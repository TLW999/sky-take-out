...
public class TestHttpClient {
    //需求1：通过httpclient 发送get请求，请求苍穹外卖用户端查看店铺营业状态接口。/user/shop/status
    @Test
    ...
    //1.需求2:通过HttpClient发送post请求，请求苍穹外卖管理端的员工登录接口。/admin/employee/login
    @Test
    public void testpost() throws Exception {
        ...
        //2.2设置请求体的编码以及类型 否则报错："status：415"
